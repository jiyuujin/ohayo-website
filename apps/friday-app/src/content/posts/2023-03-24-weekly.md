...
category: article
title: 2023/03/24 週
explain: React の新しい公式ドキュメントのローンチ、Gradle 8、Java 20、TypeScript 5.0 リリース
...
TypeScript 5.0 に付随して Prettier v2.8.5 リリース。

[Prettier v2.8.5 リリース](https://github.com/prettier/prettier/releases/tag/2.8.5)

TypeScript 5.0 に付随して、さらに TypeScript-ESLint v5.55.0 もリリース。
